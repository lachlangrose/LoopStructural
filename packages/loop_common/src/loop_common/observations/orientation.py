...
class OrientationObservation(LoopEntity):
    ...
    @classmethod
    def from_strike_dip(
        cls, coords: np.ndarray, strike: np.ndarray, dip: np.ndarray, polarity: np.ndarray
    ):
    ...
    def from_dip_direction_and_dip(
        cls, coords: np.ndarray, dip_direction: np.ndarray, dip: np.ndarray, polarity: np.ndarray
    ):
