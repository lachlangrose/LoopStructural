...
_VALIDATION_PATH = Path(__file__).parent.parent / "src" / "loop_interpolation" / "_validation.py"
_spec = importlib.util.spec_from_file_location("loop_interpolation._validation", _VALIDATION_PATH)
